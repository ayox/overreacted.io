---
title: كيف مكونات الدوال تختلف عن مكونات الأصناف؟
date: '2019-03-03'
spoiler: هن بيكمون مختلف تماماً.
---

كيف مكونات الدوال تختلف عن مكونات الأصناف؟

لفترة من الوقت, كانت الاجابة المتعارفه عليها هي ان مكونات الأصناف توفر الوصول إلى مميزات (مثل الحالة).لكن مع [الخطافات](https://reactjs.org/docs/hooks-intro.html), هذا لم يعد صحيحاً.

من المحتمل انك سمعت ان احدهن افضل من ناحية الاداء. أي واحدة؟ كثير من هذه [معيوبة](https://medium.com/@dan_abramov/this-benchmark-is-indeed-flawed-c3d6b5b6f97f?source=your_stories_page---------------------------) المعاير لهذا سأكون حذراً عند [استخلاص النتائج](https://github.com/ryardley/hooks-perf-issues/pull/2) منهن.الاداء يعتمد اساساً على وظيفة الكود سوا اختارت مكون دالة او مكون صنف.من خلال ملاحظتنا, فإن فروقات الاداء لاتذكر, على ن استراتيجيات التحسين [تختلف قليلاً](https://reactjs.org/docs/hooks-faq.html#are-hooks-slow-because-of-creating-functions-in-render).
